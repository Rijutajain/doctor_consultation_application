...
public class DoctorService {
    ...
    public Doctor register(Doctor doctor) throws InvalidInputException {
        ...
        //Added address validation inside validate method
    ...
    public Doctor getDoctor(String docId) throws ResourceUnAvailableException {
        Optional<Doctor> fetchedDoctor = doctorRepository.findById(docId);
        if (!fetchedDoctor.isPresent()) {
            throw new ResourceUnAvailableException();
        }
        return fetchedDoctor.get();
    }
